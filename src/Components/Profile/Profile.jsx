    ...
    <div>
      ...
      >
        <KeyboardBackspaceIcon
          ...
          onClick={handleBack}
        />
        <h1 className="py-5 text-xl font-bold opacity-90 ml-5">Nitin Singla</h1>
      </section>
      ...
      <section className="pl-6">
        ...
        <div>
          <div className="flex items-center">
            <h1 className="font-bold text-lg">Nitin Singla</h1>
            {true && (
              <svg
                viewBox="0 0 22 22"
          ...
          <h1 className="text-gray-500">@nitin_singla</h1>
        </div>
        <div className="mt-2 space-y-3">
          <p>Hello, I am Nitin Singla a full stack web developer.</p>
